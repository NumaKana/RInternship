...
function Popup(props) {
  ...
  return (
    <div>
      <div align="center" id="staticModal" tabIndex="-1" hidden={!props.open} className="fixed top-30 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div className="relative w-full max-w-2xl max-h-full">
          <div className="relative bg-white rounded-2xl shadow bg-white-100 border-amber-900 border-8">
            ...
            <div className="pr-6 pl-6 pb-6 space-y-6">
              ...
              <div>
                <center>
                  <img src={props.img} align="center" width={150}></img>
                </center>
              </div>
